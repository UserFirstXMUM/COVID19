...
public class DayManager {
    ...
    public static void setCurrentTime(String currentTime) {
        com.example.covid19.DayManager.currentTime = currentTime;
    }
    ...
    public static void setTempcurrent(int tempcurrent) {
        com.example.covid19.DayManager.tempcurrent = tempcurrent;
    }
    ...
    public static void setCurrent(int current) {
        com.example.covid19.DayManager.current = current;
    }

    private static int select = -1;

    public static void setSelect(int select) {
        com.example.covid19.DayManager.select = select;
    }
